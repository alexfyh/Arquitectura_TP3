...
HD_PWD='/home/alexyh/Escritorio/Arqui/Arquitectura_TP3/Arquitectura_TP3/Arquitectura_TP3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bip.tcl
