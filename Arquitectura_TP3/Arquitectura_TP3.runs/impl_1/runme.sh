...
HD_PWD='/home/alexyh/Escritorio/Arqui/Arquitectura_TP3/Arquitectura_TP3/Arquitectura_TP3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_bip.tcl -notrace
